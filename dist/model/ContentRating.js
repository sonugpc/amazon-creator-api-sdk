...
class ContentRating {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('audienceRating')) {
        obj['audienceRating'] = _SingleStringValuedAttribute.default.constructFromObject(data['audienceRating']);
      }
    }
    return obj;
  }
  ...
  static validateJSON(data) {
    ...
    if (data['audienceRating']) {
      // data not null
      _SingleStringValuedAttribute.default.validateJSON(data['audienceRating']);
    }
    return true;
  }
}
...
var _default = exports.default = ContentRating;
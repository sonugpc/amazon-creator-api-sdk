...
var _ValidationExceptionField = _interopRequireDefault(require("./ValidationExceptionField"));
var _ValidationExceptionReason = _interopRequireDefault(require("./ValidationExceptionReason"));
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('reason')) {
        obj['reason'] = _ValidationExceptionReason.default.constructFromObject(data['reason']);
      }
      if (data.hasOwnProperty('fieldList')) {
        obj['fieldList'] = _ApiClient.default.convertToType(data['fieldList'], [_ValidationExceptionField.default]);
      }
    }
    return obj;
  }
  ...
  static validateJSON(data) {
    ...
    if (data['fieldList']) {
      ...
      for (const item of data['fieldList']) {
        _ValidationExceptionField.default.validateJSON(item);
      }
      ;
    }
    return true;
...
var _default = exports.default = ValidationExceptionResponseContent;
...
var _ItemsResult = _interopRequireDefault(require("./ItemsResult"));
...
class GetItemsResponseContent {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('itemsResult')) {
        obj['itemsResult'] = _ItemsResult.default.constructFromObject(data['itemsResult']);
      }
  ...
  static validateJSON(data) {
    ...
    if (data['itemsResult']) {
      // data not null
      _ItemsResult.default.validateJSON(data['itemsResult']);
    }
    if (data['errors']) {
      // data not null
...
var _default = exports.default = GetItemsResponseContent;
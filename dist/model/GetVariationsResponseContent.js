...
var _VariationsResult = _interopRequireDefault(require("./VariationsResult"));
...
class GetVariationsResponseContent {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('variationsResult')) {
        obj['variationsResult'] = _VariationsResult.default.constructFromObject(data['variationsResult']);
      }
  ...
  static validateJSON(data) {
    ...
    if (data['variationsResult']) {
      // data not null
      _VariationsResult.default.validateJSON(data['variationsResult']);
    }
    if (data['errors']) {
      // data not null
...
var _default = exports.default = GetVariationsResponseContent;
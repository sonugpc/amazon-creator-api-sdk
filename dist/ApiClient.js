...
const OAuth2Config = require('./auth/OAuth2Config.js');
const OAuth2TokenManager = require('./auth/OAuth2TokenManager.js');
...
class ApiClient {
   ...
   */
  constructor(basePath = 'https://creatorsapi.amazon') {
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
  ...
  async callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType, apiBasePath) {
    ...
    try {
      ...
      if (!this.tokenManager) {
        const config = new OAuth2Config(this.credentialId, this.credentialSecret, this.version, this.authEndpoint);

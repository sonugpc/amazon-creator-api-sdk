...
export default class DefaultApi {
  ...
  getBrowseNodesWithHttpInfo(xMarketplace, getBrowseNodesRequestContent) {
    ...
    if (
      getBrowseNodesRequestContent === undefined ||
      getBrowseNodesRequestContent === null
    ) {
      throw new Error(
  ...
  getBrowseNodes(xMarketplace, getBrowseNodesRequestContent) {
    return this.getBrowseNodesWithHttpInfo(
      xMarketplace,
  ...
  getFeed(xMarketplace, getFeedRequestContent) {
    return this.getFeedWithHttpInfo(xMarketplace, getFeedRequestContent).then(
  ...
  getItemsWithHttpInfo(xMarketplace, getItemsRequestContent) {
    ...
    if (
      getItemsRequestContent === undefined ||
      getItemsRequestContent === null
    ) {
      throw new Error(
  ...
  getItems(xMarketplace, getItemsRequestContent) {
    return this.getItemsWithHttpInfo(xMarketplace, getItemsRequestContent).then(
      function (response_and_data) {
        return response_and_data.data;
      },
    );
  ...
  getReportWithHttpInfo(xMarketplace, getReportRequestContent) {
    ...
    if (
      getReportRequestContent === undefined ||
      getReportRequestContent === null
    ) {
      throw new Error(
  ...
  getReport(xMarketplace, getReportRequestContent) {
    return this.getReportWithHttpInfo(
      xMarketplace,
  ...
  getVariationsWithHttpInfo(xMarketplace, getVariationsRequestContent) {
    ...
    if (
      getVariationsRequestContent === undefined ||
      getVariationsRequestContent === null
    ) {
      throw new Error(
  ...
  getVariations(xMarketplace, getVariationsRequestContent) {
    return this.getVariationsWithHttpInfo(
      xMarketplace,
  ...
  listFeeds(xMarketplace) {
    return this.listFeedsWithHttpInfo(xMarketplace).then(
      function (response_and_data) {
        return response_and_data.data;
      },
    );
  ...
  listReports(xMarketplace) {
    return this.listReportsWithHttpInfo(xMarketplace).then(
      function (response_and_data) {
        return response_and_data.data;
      },
    );
  ...
  searchItems(xMarketplace, opts) {
    return this.searchItemsWithHttpInfo(xMarketplace, opts).then(
      function (response_and_data) {
        return response_and_data.data;
      },
    );
